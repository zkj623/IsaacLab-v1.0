...
from omni.isaac.lab_tasks.manager_based.locomotion.velocity.interaction_position_env_cfg import InteractionEnvCfg
...
@configclass
class UnitreeGo2InteractionEnvCfg(InteractionEnvCfg):
...
@configclass
class UnitreeGo2InteractionEnvCfg_PLAY(UnitreeGo2InteractionEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
