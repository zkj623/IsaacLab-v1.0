...
class MySceneCfg(InteractiveSceneCfg):
    ...
    #     init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.1, -0.4, 0.1], rot=[1, 0, 0, 0]),
    ...
    interactive_object: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.MultiUsdFileCfg(
            usd_path=[
                # "omniverse://localhost/Library/wooden_door3.usd",
                # training
                "omniverse://localhost/Library/cardbox.usd",
                "omniverse://localhost/Library/cardbox_T.usd",
                "omniverse://localhost/Library/barrel_big.usd",
                "omniverse://localhost/Library/barrel_small.usd",
                "omniverse://localhost/Library/chair_T.usd",
                "omniverse://localhost/Library/chair_2_T.usd",
                # test
                # "omniverse://localhost/Library/barrel_big_2.usd",
                # "omniverse://localhost/Library/barrel_small_2.usd",
                # "omniverse://localhost/Library/cardbox_2.usd",
                # "omniverse://localhost/Library/chair_3.usd",
                # "omniverse://localhost/Library/chair_4.usd",
                # "omniverse://localhost/Library/wetfloor.usd",
                # "omniverse://localhost/Library/traffic_cone.usd",
            ],
            random_choice=False,
            rigid_props=RigidBodyPropertiesCfg(
                solver_position_iteration_count=16,
    ...
    wall1 = AssetBaseCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path="omniverse://localhost/Library/Wall.usd",
        ),
    ...
    height_scanner = RayCasterCfg(
        ...
        # mesh_prim_paths=["/World/envs/env_3/Interactive_object"]
        # mesh_prim_paths=["{ENV_REGEX_NS}/Interactive_object"],
    )
...
class CommandsCfg:
    ...
    pose_command = mdp.UniformPose2dCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPose2dCommandCfg.Ranges(pos_x=(-2.0, -2.0), pos_y=(0.0, 0.0), heading=(-math.pi, math.pi)),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        object_category = ObsTerm(func=mdp.object_category, params={"object_cfg": SceneEntityCfg("interactive_object")})
        ...
        object_position = ObsTerm(
            func=mdp.relative_object_position_in_world_frame, 
        ...
        object_shape_pc = ObsTerm(
            func=mdp.object_shape_pc_optimized, 
            params={
                "object_cfg": SceneEntityCfg("interactive_object"),
                "num_points": 64,  # 减少点数以提高性能
                "min_height": 0.0,
                "max_height": 0.5
            }
        )
...
# cartpole = ArticulationCfg(
    ...
    #         pos=(1.0, 0.0, 0.5), joint_pos={"slider_to_cart": 0.0, "cart_to_pole": 0.0}
    #     ),
    #     actuators={
