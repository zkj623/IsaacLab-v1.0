...
# Pre-defined configs
##
from omni.isaac.lab.terrains.config.rough import ROUGH_TERRAINS_CFG, CLIMB_TERRAINS_CFG  # isort: skip
...
class CommandsCfg:
    ...
    pose_command = mdp.TerrainBasedPose2dCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPose2dCommandCfg.Ranges(pos_x=(5.0, 5.0), pos_y=(0.0, 0.0), heading=(0, 0)),
        # ranges=mdp.UniformPose2dCommandCfg.Ranges(pos_x=(5.0, 5.0), pos_y=(-2.0, 2.0), heading=(-math.pi, math.pi)),
    )
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            ...
            lin_vel_x=(0.8, 1.0), lin_vel_y=(0, 0), ang_vel_z=(-0.0, 0.0), heading=(-math.pi, math.pi) # climb stairs
        ),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # actions = mdp.JointPositionActionCfg(asset_name="robot", joint_names=[".*"], scale=0.5, use_default_offset=True)
        height_scan = ObsTerm(
...
class LocomotionPositionRoughEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        # general settings
        self.decimation = 4
        self.episode_length_s = 12.0 # 8.0
        # simulation settings
        self.sim.dt = 0.005
