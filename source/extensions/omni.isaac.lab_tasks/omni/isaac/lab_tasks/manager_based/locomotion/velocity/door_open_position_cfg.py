...
class MySceneCfg(InteractiveSceneCfg):
    ...
    box_1: RigidObjectCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.6, -0.2, 0.1], rot=[1, 0, 0, 0]),
    ...
    #         usd_path="omniverse://localhost/Library/wooden_door.usd",
    #     ),
    #     init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, 1.0, 0.0), rot=[1, 0, 0, 0]),
    # )
    ...
    wall1 = AssetBaseCfg(
        ...
        # init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, 2.6, 0.0), rot=[0.707, 0, 0, 0.707]),
    )
    ...
    wall2 = AssetBaseCfg(
        ...
        # init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -2.45, 0.0), rot=[0.707, 0, 0, 0.707]),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # pull door
        # object_yaw = ObsTerm(func=mdp.object_yaw, params={"object_cfg": SceneEntityCfg("door")})
...
class EventCfg:
    ...
    reset_door_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0, 0), "y": (0, 0), "z": (0.0, 0.0), "yaw": (0.0, 0.0)},
            # "pose_range": {"x": (0, 0), "y": (0, 0), "z": (0.0, 0.0), "yaw": (1.57, 1.57)},
            "velocity_range": {},
...
class RewardsCfg:
    ...
    # door_yaw_reward = RewTerm(
    #     func=mdp.object_yaw_reward,
    #     weight=2.0,
    #     params={"target_yaw": 4.71, "std": 1.0, "object_cfg": SceneEntityCfg("door")},
    # )
...
@configclass
class DoorOpenEnvCfg(ManagerBasedRLEnvCfg):
