...
# class UnitreeGo2RoughEnvCfg(LocomotionPositionRoughEnvCfg):
    def __post_init__(self):
        ...
        self.events.reset_base.params = {
            "pose_range": {"x": (-0.5, 0.5), "y": (-0.5, 0.5), "yaw": (-3.14, 3.14)}, # arbitrary walking
            # "pose_range": {"x": (-3.0, -3.0), "y": (0, 0), "z": (0, 0), "yaw": (0, 0)}, # climb stairs
            # "pose_range": {"x": (-3.0, -2.5), "y": (-1.0, 1.0), "z": (0, 0), "yaw": (-1.57, 1.57)}, # robust climb stairs
            "velocity_range": {
                "x": (0.0, 0.0),
                "y": (0.0, 0.0),
                "z": (0.0, 0.0),
