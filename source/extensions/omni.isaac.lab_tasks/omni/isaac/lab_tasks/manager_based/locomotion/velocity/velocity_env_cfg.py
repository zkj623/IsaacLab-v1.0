...
from omni.isaac.lab.terrains.config.navigate_anywhere import NAVIGATE_ANYWHERE_CFG
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            ...
            lin_vel_x=(0.5, 1.0), lin_vel_y=(0, 0), ang_vel_z=(-0.0, 0.0), heading=(-math.pi, math.pi) # climb stairs
            # lin_vel_x=(0.0, 0.0), lin_vel_y=(0, 0), ang_vel_z=(-0.0, 0.0), heading=(-math.pi, math.pi) # keep static
        ),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        height_scan = ObsTerm(
            ...
            # params={"sensor_cfg": SceneEntityCfg("height_scanner"), "object_cfg": SceneEntityCfg("box_1")},
            # params={"sensor_cfg": SceneEntityCfg("height_scanner"), "object_cfg": SceneEntityCfg("box_3")},
