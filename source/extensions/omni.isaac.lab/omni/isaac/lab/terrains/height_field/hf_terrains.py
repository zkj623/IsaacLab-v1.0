...
@height_field_to_mesh
def high_obstacles_terrain(difficulty: float, cfg: hf_terrains_cfg.HfHighObstaclesTerrainCfg) -> np.ndarray:
    # resolve terrain configuration
    obs_height = cfg.obstacle_height_range[0] + difficulty * (
        cfg.obstacle_height_range[1] - cfg.obstacle_height_range[0]
    )
    ...
    # hf_raw[15:25, 55:63] = 100
    # hf_raw[65:75, 55:60] = 100
    # hf_raw[43:52, 55:58] = 100
    # hf_raw[40:43, 55:65] = 100
    # hf_raw[5:30, 15:22] = 90
    # hf_raw[33:48, 23:29] = 110
    # hf_raw[50:53, 27:48] = 120
    # hf_raw[53:63, 39:43] = 120

    center_x, center_y = 38, 35
    radius = 4
    # y, x = np.ogrid[:hf_raw.shape[0], :hf_raw.shape[1]]
    ...
    two_layer_height = 0
    hf_raw[32:75, 38:75] = two_layer_height
    hf_raw[11:23, 55:65] = height
    hf_raw[55:75, 60:75] = 85 + two_layer_height
    hf_raw[40:50, 17:28] = 140 + two_layer_height
    hf_raw[5:30, 15:20] = 120 + two_layer_height
    hf_raw[52:55, 48:55] = 120 + two_layer_height

    # simulation3

    # hf_raw[11:24, 55:65] = height
    # hf_raw[50:75, 58:75] = 110
    # # hf_raw[50:65, 45:52] = 40
    # hf_raw[30:50, 17:25] = 140
    # hf_raw[5:20, 18:23] = 120
    # hf_raw[20:23, 18:23] = 120
    # hf_raw[22:25, 38:48] = 120

    # simulation4
    # hf_raw[11:19, 17:22] = 120

    # hf_raw[35:43, 29:55] = 120
    # hf_raw[43:46, 29:55] = 90
    # hf_raw[46:49, 29:55] = 60
    # hf_raw[49:52, 29:55] = 30
    # hf_raw[55:75, 58:75] = 120
    # hf_raw[55:75, 53:58] = 120
    # # hf_raw[67:75, 45:52] = 40

    # hf_raw[26:29, 5:29] = 120
    # hf_raw[52:55, 55:75] = 120
    # hf_raw[5:55, 55:58] = 120
    # hf_raw[25:75, 27:29] = 120

    # simulation5
    # hf_raw[11:19, 17:22] = 120

    # hf_raw[28:30, 29:45] = 90
    # hf_raw[55:75, 58:75] = 120
    # hf_raw[55:75, 53:58] = 120
    # # hf_raw[67:75, 45:52] = 40
    ...
    # # area_limit
    hf_raw[1:4, 1:78] = 120
    hf_raw[75:78, 1:78] = 120
    hf_raw[1:78, 1:4] = 120
    hf_raw[1:78, 75:78] = 120
